 ...
 * 		propsDynamic是每次动态加载
 */
public class MallPropertyUtils {
	...
	static {
		try {
			propsDefault.load(MallPropertyUtils.class.getClassLoader().getResourceAsStream("config.properties"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public static String get(String fileName,String key){
		String value = null;
		try {
			InputStream in = MallPropertyUtils.class.getClassLoader().getResourceAsStream(fileName);
